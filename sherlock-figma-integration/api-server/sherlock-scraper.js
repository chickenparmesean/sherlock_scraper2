...
import { defaultConfig, isValidSherlockUrl } from './config';
    ...
    async scrapeProfileImage(sherlockUrl, options) {
        ...
        try {
            ...
            if (opts.convertToBase64) {
                const conversionResult = await ImageUtils.convertToBase64(imageResult.profileImageUrl, opts.timeout || 10000);
                    ...
                    if (/^\d+$/.test(text)) {
                        ...
                        if (number === 1) {
                            ...
                            $el.parents().each((index, parent) => {
                                ...
                                const parentTag = ((_a = parent.tagName) === null || _a === void 0 ? void 0 : _a.toLowerCase()) || 'unknown';
